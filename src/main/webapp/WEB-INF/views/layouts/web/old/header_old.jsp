...
<nav class="main-header navbar navbar-expand navbar-white navbar-light pb-0 mb-0" 
	style="border-bottom: 0px solid #343a40; height: 130px; background-color: #04355d; color: white;">
    <!-- Left navbar links -->
...
// Khai báo tuần hiện tại
    ...
    var file_upload_accept_chuoi_dau_2 = "Báo cáo KH KD Viễn thông tuần";
    var file_upload_accept_chuoi_dau_3 = "Báo cáo KH KD Chuyển đổi số tuần";
    
    var file_upload_accept_chuoi_sau = "tháng " + file_month + " năm " + file_year + ".xlsx";
